...
namespace AmivoiceWatcher
{
    class UserActivityThread
    {
        ...
        private static string _agentactivity_url = Configuration.configuration["agentactivity.url"];
        private static string _path_unsent_activities = MyPath.unsent_activities;
        ...
        private static void SetTimer()
        {
            ...
            if (Double.TryParse(Configuration.configuration["agentactivity.senddata.timer.sec"], out dblTimer))
